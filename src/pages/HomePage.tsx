...
export default function HomePage() {
  ...
  <div id="servicios" data-section="servicios">
    <SectionErrorBoundary name="servicios">
      ...
      items={[
        { title: "Diseño web", description: "Diseños a medida que destacan tu marca profesionalmente.", href: "#", imageSrc: "http://img.b2bpic.net/free-photo/outline-responsive-design_1134-80.jpg" },
